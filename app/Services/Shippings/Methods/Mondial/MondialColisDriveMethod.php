...
class MondialColisDriveMethod extends MondialRelayShipping implements MethodInterface
{
    private const ID   = "mondial_relay_colis_drive";
    public const TITLE = 'Mondial Relay Colis Drive';
