                            ...
                            if ( isReceiver ) {
                                template += `
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <form action="${MdsConfig.baseURL}/accept-quote-post" method="post">
                                            <input name="csrf_token" value="${csrf}" type="hidden"/>
                                            <input type="hidden" name="id" class="form-control" value="${id}">
                                            <input type="hidden" name="back_url" class="form-control" value="${window.location.href}">
                                        ...
                                        <form action="${MdsConfig.baseURL}/reject-quote-post" method="post" class="mx-2">
                                            <input name="csrf_token" value="${csrf}" type="hidden"/>
                                            <input type="hidden" name="id" class="form-control" value="${id}">
                                            <input type="hidden" name="back_url" class="form-control" value="${window.location.href}">
                                        ...
                                        <button type="button" class="btn btn-sm mx-2 btn-primary" data-toggle="modal" data-target="#counterOfferModal-${id}">
